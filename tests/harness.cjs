...
async function create(shared, options = {}) {
  ...
  ['js/domain.js','js/storage.js','js/indexeddb.js','js/core.js','js/safety.js','js/migrations.js','js/i18n.js','js/auth.js','js/backup.js','js/returns.js','js/voice.js','js/qr.js','js/ui.js','js/pos.js','js/insights.js','js/ledger.js','js/inventory.js','js/settings.js'].forEach(load);
