...
Read the pushed BUILD-17 code/report and its predecessor evidence. Pin the actual code commit and application tree; identify whether the reviewer is independent or the implementer. Do not infer a pass from CI or from this planning card.
...
7. Inspect recovery: If hardware is unavailable, push code/report as blocked and keep support disabled; a screenshot or mock cannot close VERIFY-17.
