...
Read the pushed BUILD-06 code/report and its predecessor evidence. Pin the actual code commit and application tree; identify whether the reviewer is independent or the implementer. Do not infer a pass from CI or from this planning card.
...
4. Check **every prior build**: [BUILD-01](BUILD-01.md), [BUILD-02](BUILD-02.md), [BUILD-03](BUILD-03.md), [BUILD-04](BUILD-04.md), [BUILD-05](BUILD-05.md).
...
7. Inspect recovery: Carry migrated balances as disclosed opening checkpoints; retain evidence of exceptions; disable new entry UI rather than deleting ledger entries on rollback.
