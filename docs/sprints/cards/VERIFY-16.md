...
Read the pushed BUILD-16 code/report and its predecessor evidence. Pin the actual code commit and application tree; identify whether the reviewer is independent or the implementer. Do not infer a pass from CI or from this planning card.
...
7. Inspect recovery: Keep existing print/export fallback; publish dimensions and rendered samples, with simulated output clearly labelled.
